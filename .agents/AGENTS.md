...
A primary goal for `git-staircase` is to act as idiomatically 'git' in terms of UI presentation as possible. 
...
- Move toward completing all scenarios in CONFORMANCE.md.
