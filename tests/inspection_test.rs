...
fn test_status_output_format_alignment() {
    ...
    assert!(stdout.contains("  symbolic_integration_target: refs/heads/main"));
...
fn test_status_output_format_alignment_managed() {
    ...
    assert!(
        stdout.contains("  symbolic_integration_target: refs/heads/main\n"),
        "Output should contain symbolic_integration_target"
    );
    assert!(
