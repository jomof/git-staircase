...
fn test_git_command_error_quoting() {
    ...
    match res {
        Err(e) => {
            ...
            assert!(msg.contains("git rev-parse --verify \"invalid ref with spaces\"") || msg.contains("git rev-parse --verify 'invalid ref with spaces'"), 
                "Error message should contain quoted arguments: {}", msg);
        }
